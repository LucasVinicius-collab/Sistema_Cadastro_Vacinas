...
public final class SomenteNumeros extends JTextField {
    ...
    private void jTextFieldKeyTyped(KeyEvent evt) {
        ...
        String caracteres="0987654321/";// lista de caracters que não devem ser aceitos
            if(!caracteres.contains(evt.getKeyChar()+"")){// se o caracter que gerou o evento estiver não estiver na lista. Note o ! oara excuir letras;
